...
export const HeroSection: FC = () => {
  ...
  return (
    <section className="bg-white relative overflow-hidden"
      ...
      <div className="absolute inset-0 bg-[#256FFF]/[0.02] pattern-grid-lg"></div>

      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center text-center min-h-[400px] max-w-4xl mx-auto relative">
          <div className="relative">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-[#1E1E1E]">
              Por que <span className="text-[#256FFF]">Pousar</span>
              <br />é melhor que decolar!
            </h1>

            <div className="bg-white border-2 border-[#256FFF] px-8 py-4 rounded-lg mb-8 relative shadow-lg">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button 
          className="bg-[var(--pousar-primary)] hover:bg-[var(--pousar-primary-hover)] text-[var(--pousar-background)] rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-105"
        >
